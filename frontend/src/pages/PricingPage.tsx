...
const packages: Package[] = [
  {
    ...
    badge: 'Package 1',
    name: 'Starter',
    subtitle: 'Perfect for small businesses & solo professionals',
    totalPrice: '₦298,500',
    popular: false,
    Icon: Medal,
    gradientFrom: '#CD7F32',
    gradientTo: '#A0522D',
    glowClass: 'hover:shadow-[0_0_40px_rgba(205,127,50,0.25)]',
    ...
    lineItems: [
      ...
      { label: 'Domain Registration (.com — 1 year)', amount: '₦8,500' },
      { label: 'Web Hosting (1 year)', amount: '₦25,000' },
      { label: 'Business Email (2 accounts)', amount: '₦15,000' },
      { label: 'SSL Certificate (1 year)', amount: 'FREE', isFree: true },
    ],
    monthlySupport: '₦10,000/month',
    annualRenewal: '₦48,500/year',
    delivery: '1–2 Weeks',
  },
  {
    id: 'business',
    badge: 'Package 2',
    name: 'Business',
    subtitle: 'Ideal for growing SMEs & service companies',
    totalPrice: '₦603,500',
    popular: false,
    Icon: Zap,
    gradientFrom: '#64748B',
    gradientTo: '#475569',
    glowClass: 'hover:shadow-[0_0_40px_rgba(100,116,139,0.25)]',
    idealFor: ['Growing SMEs', 'Engineering firms', 'Schools', 'Hotels', 'Healthcare providers'],
    lineItems: [
      { label: 'Website Development (up to 10 pages)', amount: '₦500,000' },
      { label: 'Domain Registration (.com — 1 year)', amount: '₦8,500' },
      { label: 'Web Hosting (1 year — performance tier)', amount: '₦40,000' },
      { label: 'Business Email (5 accounts)', amount: '₦25,000' },
      { label: 'SSL Certificate (1 year)', amount: 'FREE', isFree: true },
      { label: 'SEO Setup & Configuration', amount: '₦30,000' },
    ],
    monthlySupport: '₦20,000/month',
    annualRenewal: '₦73,500/year',
    delivery: '2–3 Weeks',
  },
  {
    id: 'professional',
    badge: 'Package 3',
    name: 'Professional',
    subtitle: 'Best for established companies & corporates',
    totalPrice: '₦1,155,000',
    popular: true,
    popularLabel: 'RECOMMENDED FOR BMEL',
    Icon: Trophy,
    gradientFrom: '#F59E0B',
    gradientTo: '#D97706',
    ...
    idealFor: [
      ...
      'Engineering corporates',
      'Multinationals',
      'Large organizations',
    ],
    lineItems: [
      { label: 'Website Development (up to 20 pages)', amount: '₦950,000' },
      { label: 'Domain Registration (.com + .com.ng — 1 year)', amount: '₦15,000' },
      { label: 'Web Hosting (1 year — premium Cloudflare/VPS)', amount: '₦60,000' },
      { label: 'Business Email (10 accounts)', amount: '₦40,000' },
      { label: 'SSL Certificate (1 year)', amount: 'FREE', isFree: true },
      { label: 'Advanced SEO Setup & Analytics', amount: '₦50,000' },
      { label: 'Content Strategy & Copywriting', amount: '₦40,000' },
    ],
    monthlySupport: '₦35,000/month',
    annualRenewal: '₦115,000/year',
    delivery: '3–5 Weeks',
    deliveryNote:
      'Includes custom design, filterable gallery, animated counters, quote request system, careers page, blog, multilingual support, WhatsApp integration, and premium animations.',
  },
  {
    id: 'enterprise',
    badge: 'Package 4',
    name: 'Enterprise',
    subtitle: 'For large organizations & multinationals',
    totalPrice: '₦2,725,000',
    popular: false,
    Icon: Gem,
    gradientFrom: '#6366F1',
    gradientTo: '#4F46E5',
    glowClass: 'hover:shadow-[0_0_40px_rgba(99,102,241,0.25)]',
    idealFor: [
      'Large organizations',
      'Logistics companies',
      'Manufacturing firms',
    ...
    lineItems: [
      { label: 'Website Development (unlimited pages)', amount: '₦2,000,000' },
      { label: 'Domain Registration (.com + .com.ng + .ng — 1 year)', amount: '₦25,000' },
      { label: 'Web Hosting (1 year — dedicated/enterprise)', amount: '₦120,000' },
      { label: 'Business Email (25+ accounts with admin panel)', amount: '₦80,000' },
      { label: 'SSL Certificate (1 year)', amount: 'FREE', isFree: true },
      { label: 'Enterprise SEO Strategy (3-month execution)', amount: '₦150,000' },
      { label: 'Brand Strategy & Content Production', amount: '₦100,000' },
      { label: 'Custom Admin Dashboard / CMS', amount: '₦250,000' },
    ],
    monthlySupport: '₦60,000/month',
    annualRenewal: '₦225,000/year',
    delivery: '6–10 Weeks',
  },
]
...
const comparisonRows = [
  { label: 'Number of Pages', values: ['Up to 5', 'Up to 10', 'Up to 20', 'Unlimited'] },
  { label: 'Custom Design', values: ['Template-based', 'Semi-custom', 'Fully custom', 'Custom + brand'] },
  { label: 'Mobile Responsive', values: [true, true, true, true] },
  { label: 'Contact Form', values: ['Basic', 'Advanced (multi-step)', 'Advanced + file uploads', 'Advanced + CRM'] },
  { label: 'SEO Optimization', values: ['Basic on-page', 'Standard SEO', 'Advanced + analytics', 'Enterprise SEO'] },
  { label: 'Blog / News', values: [false, true, true, true] },
  { label: 'Project Gallery', values: [false, 'Basic grid', 'Filterable + lightbox', 'Interactive + case studies'] },
  { label: 'Testimonials', values: [false, 'Static', 'Animated carousel', 'Video testimonials'] },
  { label: 'Multilingual (i18n)', values: [false, false, '✓ 2 languages', '✓ Unlimited'] },
  { label: 'Live Chat', values: [false, false, '✓ WhatsApp', '✓ Custom Chatbot'] },
  { label: 'Careers Portal', values: [false, false, 'Basic listings', 'Full application system'] },
  { label: 'Quote Request', values: [false, false, true, '✓ + Auto-response'] },
  { label: 'Admin Dashboard', values: [false, false, 'Basic', 'Full-featured CMS'] },
]

const maintenancePlans = [
  { pkg: 'Starter', monthly: '₦10,000/month', annual: '₦102,000/year' },
  { pkg: 'Business', monthly: '₦20,000/month', annual: '₦204,000/year' },
  { pkg: 'Professional', monthly: '₦35,000/month', annual: '₦357,000/year' },
  { pkg: 'Enterprise', monthly: '₦60,000/month', annual: '₦612,000/year' },
]
  ...
  return (
    <>
      <SEO
        ...
        description="Explore Brownforte's website development pricing — Starter ₦298,500 · Business ₦603,500 · Professional ₦1,155,000 · Enterprise ₦2,725,000. Transparent, all-inclusive Nigerian pricing."
